...
PRESET_KEYS = {"net": "net_select", "order": "order_select", "side": "side_slider", "nodes": "nodes_slider", "degree": "degree_slider", "distance": "distance_slider", "seed": "seed_input"}
...
KEPT = {key: f"_kept_{key}" for key in ("side_slider", "nodes_slider", "degree_slider", "distance_slider", "seed_input")}
...
def load_permalink_settings():
    ...
    if "degree_slider" in st.session_state:
        st.session_state["degree_slider"] = round(round(st.session_state["degree_slider"] / 0.5) * 0.5, 2)
    if "nodes_slider" in st.session_state:
        st.session_state["nodes_slider"] = int(round(st.session_state["nodes_slider"] / 10) * 10)
